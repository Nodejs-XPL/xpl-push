...
const debug = require('debug')('xpl-push:httpServer');
...
class HttpServer {
  ...
  _register(rule, request, response) {
    ...
    debug("_register", "Headers=",request.headers);
    ...
    debug("_register", "Register client params=",params,"agent=",agent,"rule=",rule.id);
